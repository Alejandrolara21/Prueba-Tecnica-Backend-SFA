...
def api_list_department(request, pk=None):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def api_list_city(request, pk=None):
    if(request.method == 'GET'):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def api_list_neighborhood(request, pk=None):
    if(request.method == 'GET'):
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def api_list_polling_place(request, pk=None):
    if(request.method == 'GET'):
